...
export type ProfileIn = typeof ProfileIn
export const ProfileIn = { username: '' }

export type ResetPasswordIn = typeof ResetPasswordIn
export const ResetPasswordIn = { old: '', new: '' }

export const UpdateProfile = (data: ProfileIn) => admins.Put<string>({ sub: '/profile', data, includes: ['username'] })
export const ResetPassword = (data: ResetPasswordIn) =>
  admins.Put<string>({ sub: '/password', data, includes: ['old', 'new'] })

export type Stats = typeof Stats
export const Stats = { admins: 0, users: 0 }

const stats = api.Group('/stat', authorization)
export const GetStats = () => stats.Get<Stats>()
