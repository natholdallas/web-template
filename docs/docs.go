    ...
    "paths": {
        ...
        "/adm/api/v1/stat": {
            "get": {
                ...
                "operationId": "admGetStats",
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/AdmStats"
                        }
                    }
                }
            }
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/UsrResetPasswordIn"
                        }
                    }
                ],
                "responses": {
    ...
    "definitions": {
        ...
        "Fail": {
            ...
            "properties": {
                ...
                "system": {
                    "description": "Raw system error (only shown in debug mode)"
                }
            }
        },
        "User": {
